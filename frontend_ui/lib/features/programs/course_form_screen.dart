      ...
      children: [
        ...
        InkWell(
          onTap: () async {
                      ...
                      content: SizedBox(
                        ...
                        child: ListView(
                          ...
                          children: programs.map((program) {
                            final isSelected =
                            tempSelected.contains(program.id);
            ...
            if (selected != null) {
              setState(() {
                ...
                // 👇 Recalculate available years here
                final selectedPrograms = programs
                    .where((p) =>
                    _selectedProgramIds.contains(p.id))
                    .toList();

                if (selectedPrograms.isNotEmpty) {
                  final minDuration = selectedPrograms
                      .map((p) => p.duration)
                      .reduce((a, b) => a < b ? a : b);
          ...
          child: Container(
            ...
            child: _selectedProgramIds.isEmpty
